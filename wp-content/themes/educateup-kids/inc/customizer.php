...
function educateup_kids_customize_preview_js() {
	wp_enqueue_script( 'educateup-kids-customizer', get_stylesheet_directory_uri() . '/assets/js/customizer.min.js', array( 'customize-preview', 'educateup-customizer' ), '1.0', true );
}
add_action( 'customize_preview_init', 'educateup_kids_customize_preview_js' );


function educateup_kids_custom_control_scripts() {
	wp_enqueue_script( 'educateup-kids-custom-controls-js', get_stylesheet_directory_uri() . '/assets/js/custom-controls.min.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-sortable', 'educateup-custom-controls-js' ), '1.0', true );
}
