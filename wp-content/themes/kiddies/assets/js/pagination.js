...
let loadButtonWrapper = document.querySelector(".kiddies-load-posts-btn-wrapper");
let loadButton = document.querySelector(
    ".kiddies-load-posts-btn-wrapper .load-btn"
);
let loader = document.querySelector(".kiddies-ajax-loader");
let articleWrapper = document.querySelector(".kiddies-article-wrapper");
    ...
    fetchThePosts: function () {
        ...
        fetch(KiddiesVars.ajaxurl, {
            ...
            body: new URLSearchParams({
                action: "kiddies_load_posts",
                nonce: KiddiesVars.nonce,
                query_vars: KiddiesVars.query_vars,
                page: nextPage,
            }),
        })
            .then((response) => {
