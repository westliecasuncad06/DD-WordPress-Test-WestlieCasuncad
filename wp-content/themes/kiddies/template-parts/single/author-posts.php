...
$author_posts_text = kiddies_get_option('author_posts_text');
$no_of_author_posts = absint(kiddies_get_option('no_of_author_posts'));
$order = esc_attr(kiddies_get_option('author_posts_order'));
$orderby = esc_attr(kiddies_get_option('author_posts_orderby'));
