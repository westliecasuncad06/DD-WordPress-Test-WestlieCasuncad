...
$related_posts_text = kiddies_get_option('related_posts_text');
$no_of_related_posts = absint(kiddies_get_option('no_of_related_posts'));
$order = esc_attr(kiddies_get_option('related_posts_order'));
$orderby = esc_attr(kiddies_get_option('related_posts_orderby'));
